...
Run: python3 feature_engineering.py
Produces: processed_telemetry.csv (used by Module 5's model training)
          eda_plots.png (sanity-check visualizations)
"""
...
RAW_PATH = "telemetry.csv"
OUT_PATH = "processed_telemetry.csv"
PLOT_PATH = "eda_plots.png"
